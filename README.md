...
### 🎮 Gaming Optimization
- **Game Mode**: Instantly toggle Windows Game Mode on/off.
...
### 🌐 Network Stabilizer
- **DNS Optimizer**: Quick-switch to Cloudflare (1.1.1.1) or Google (8.8.8.8) DNS.
...
### 🖨️ Drivers & Reports
- **Driver List**: Read real-time WMI queries of installed drivers and their versions.
...
**Step 1 — Download**  
⬇️ [Download NITRO OPTIMISER v1.0.0.exe](https://github.com/Nitrodz00/NITRO-OPTIMISER/releases/latest/download/NITRO.OPTIMISER.exe)
